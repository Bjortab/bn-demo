...
// Stories (nu med nivåer 1–5 där det passar)
window.BN_STORIES = [
  ...
  {id:"a2", lvl:[2,3,4,5],     cats:['lekfullt','sensuellt'],title:"Hemma-dejt: enkel",       ingress:"Musik, ljus, tre lekfulla moment.",        body:"Byt miljö hemma. Välj lista. Tre moment: långsam beröring, ögonkontakt i 30 sek, eftervård."},
  ...
  {id:"a4", lvl:[3,4,5],       cats:['sensuellt','återkoppling'], title:"Sensuell guidning",  ingress:"Långsam rytm, styr med ord.",              body:"Lyssna på kroppen. Stanna. Be om mer eller mindre. Avsluta med eftervård och vatten."}
];
...
window.BN_PEOPLE = [
  ...
  {alias:'Iris', level:5, pref:'sensuellt', about:'Tycker om explicit språk och långsam guidning.'},
  {alias:'Mika', level:4, pref:'romantik',  about:'Vill ha mellan–hög intensitet, tryggt tempo.'}
];
